					...
					<table cellspacing="0" class="infocontent">
						<tr>
							<td style="padding:20px"><p>欢迎${user.username }光临商城！</p>
								<p>
									您有<font style="color:#FF0000">${nums }</font>个订单
								</p>
								<table width="100%" border="0" cellspacing="0" class="tableopen">
									...
									<tr>
										...
										<td class="tableopentd03"><a href="${pageContext.request.contextPath }/findOrderByOrderId?id=${order.id}">查看</a>&nbsp;&nbsp;
											<a href="${pageContext.request.contextPath }/deleteOrderByOrderId?id=${order.id}">刪除</a>
										</td>
									</tr>
