											...
											<table cellspacing="1" class="carttable">
												...
												<table width="100%" border="0" cellspacing="0">
													...
													<tr>
														...
														<td width="10%"><a href="${pageContext.request.contextPath }/deleteCart?id=${cart.key.id}"
															style="color:#FF0000; font-weight:bold">X</a></td>
													</tr>
													<c:set var="sumprice" value="${sumprice+cart.value*cart.key.price }"></c:set>
													</c:forEach>
												</table>
											...
											<table cellspacing="1" class="carttable">
												<tr>
													<td style="text-align:right; padding-right:40px;"><font
														style="color:#FF6600; font-weight:bold">合计：&nbsp;&nbsp;${sumprice }元</font>
													</td>
												</tr>
											</table>
