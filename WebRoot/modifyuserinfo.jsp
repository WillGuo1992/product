			...
			<tr>
				...
				<td>
					...
					<table cellspacing="0" class="infocontent">
						<tr>
							<td>
								<form action="${pageContext.request.contextPath }/modifyUserServlet" method="post" id="modifyform">
									...
									<table width="100%" border="0" cellspacing="2" class="upline">
										...
										<tr>
											<td style="text-align:right">${modify_error }</td>
											<td>&nbsp;</td>
											<td>&nbsp;</td>
										</tr>
									</table>
									...
									<p style="text-align:center">
										...
										<input type="image" src="images/botton_gif_025.gif" border="0" onclick="submitform()">
